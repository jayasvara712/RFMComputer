                ...
                <div class="card-body">
                    ...
                    <form action="/admin/barang/{{ $barang->id_barang }}" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="kode_barang" value="{{ old('kode_barang', $barang->kode_barang) }}" readonly>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <select name="id_jenis" id="" class="form-control">
                            @foreach ($jenis as $jenis) 
                                @if (old('id_jenis', $barang->id_jenis) == $jenis->id_jenis)
                        ...
                        <label>Satuan Barang</label>
                            <select name="id_satuan" id="" class="form-control">
                                @foreach ($satuan as $satuan) 
                                    @if (old('id_satuan', $barang->id_satuan) == $satuan->id_satuan)
                      ...
                      <div class="form-group">
                        ...
                        <input type="hidden" name="oldImage" value="{{ $barang->gambar }}">
                            @if ($barang->gambar)
                                <img src="{{ asset('storage/'.$barang->gambar) }}" alt="" class="img-preview img-fluid mb-3 col-sm-5 d-block">
                             @else
